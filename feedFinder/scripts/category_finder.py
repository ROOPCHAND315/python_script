...
def category_finder():
    ...
    category_dict2 = {
        ...
        'environment': ['environment','climate', 'nature','earth','weather','atmosphere'],
        'food': ['food','restaurants', 'recipes','gastronomy'],
        'health': ['health','wellness', 'fitness','coronavirus'],
        'politics': ['politics','policiales','government', 'elections','security','justice','parliament'],
        'science': ['science','research', 'discovery','physics','space','astrology'],
        'sports': ['sports','sport','athletics', 'competitions','golf', 'football', 'basketball','/ipl', 'tennis', 'cricket', 'baseball', 'rugby', 'hockey','soccer'],
        'technology': ['technology','automobiles','gadgets', 'innovation','tech','smartphones','software','tablets'],
        'top': ['top/','local','things-to-do/','famous','society','popular','president', 'trending','feature','breaking','magazine','latest/','states','/national/','columns','interviews','nation'],
